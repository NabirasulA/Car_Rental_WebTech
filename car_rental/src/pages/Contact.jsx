...
// import '../nav_styles.css/contact.css'
...
//       </div>
//       <p>
//         Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem, alias similique consequatur quam minima,<br /> voluptates quae aut nostrum amet provident aperiam, saepe repudiandae! Aspernatur aperiam cumque eos <br />accusantium amet! Tenetur!
//       </p>

//       <div className="mt-4 mb-4 office_details">
//             <h5 className="mb-4 Office">Head Office</h5>
...
const Contact=() => {
  ...
  const handleSubmit=(e)=>{
    ...
    axios.post('http://localhost:3001/contact',{first_name,last_name,email,phone,message})
            ...
            <div className="w-auto p-8">
              <a href="#">
                <div className="inline-flex items-center">
                  ...
                  <span className="ml-4 text-lg font-bold">RoadFlex</span>
                </div>
              </a>
            </div>
            <div className="w-auto p-8">
